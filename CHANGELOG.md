...
### iOS
#### Fixed
- An issue with invalid response language attribute in analysis tab after using `setLocale()` method.
...
### Android
#### Improved
- Nested scrolling in input fields for Text questions and comments in Android.
